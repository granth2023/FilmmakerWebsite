# Generated by Django 4.2.2 on 2024-01-31 23:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('script', models.FileField(blank=True, null=True, upload_to='', verbose_name='/scripts')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.discussionboard'),
        ),
        migrations.AddField(
            model_name='comment',
            name='likes',
